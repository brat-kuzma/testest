...
public class ComputeAsyncExample {
    ...
    public static void main(String[] args) throws IgniteException {
        try (Ignite ignite = Ignition.start("/home/sbt-kuznetsov-dg/GG/apache-ignite-2.7.5-bin/example-ignite.xml")) {
            System.out.println();
            ...
            for (final String word : "Print.java words using runnable".split(" ")) {
